...
class Mssql{
  ...
  function __construct($baza, $args){
    $this->args = $args;
    $this->baza = $baza;
  ...
  function insert($table, $arr){
    ...
    if ($this->baza->insert_autocommit){ //check wherever autocommit is on.
      $this->baza->insert_countcommit++;
      
      if ($this->baza->insert_countcommit >= $this->baza->insert_autocommit){
        $this->baza->trans_commit();
        $this->baza->trans_begin();
        $this->baza->insert_countcommit = 0;
      }
    }
